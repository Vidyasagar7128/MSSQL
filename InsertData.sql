...
--------------------------------------------------candidate_bank_det---------------------
insert into candidate_bank_det values('Vikas',075611610021545,1,'BKID002154',1,'CSIPG052J',1,321549874512,1,1,NULL,1);
insert into candidate_bank_det values('Manoj',075611610025445,1,'ICICI002154',1,'CSIPB012J',1,541549874512,1,2,NULL,2);
insert into candidate_bank_det values('Navnath',098611610021545,1,'HDFC002154',1,'CSIEG012J',1,651549874512,1,3,NULL,3);
insert into candidate_bank_det values('Atul',12511610021545,1,'KTK002154',1,'CSING042J',1,681549874512,1,4,NULL,2);
insert into candidate_bank_det values('Prem',845611610021545,1,'PAYTM0021',1,'CSIPG013J',1,681549874512,1,5,NULL,4);

select * from candidate_bank_det
truncate table candidate_bank_det
--------------------------------------------------candidate_qualification----------------------
insert into candidate_qualification values(1,1,'BCA',1,'Good',1,2017,1,80.65,88.00,1,'SRTMUN',1,24,1,1,1,NULL,1);
insert into candidate_qualification values(2,1,'MCA',1,'Good',1,2018,1,79.65,7.00,1,'SRTMUN',1,24,1,1,1,NULL,1);
insert into candidate_qualification values(3,1,'MCA',1,'Good',1,2019,1,68.65,68.00,1,'SRTMUN',1,24,1,1,1,NULL,2);
insert into candidate_qualification values(4,1,'MCA',1,'Good',1,2020,1,78.65,67.00,1,'SRTMUN',1,24,1,1,1,NULL,3);
insert into candidate_qualification values(5,1,'BCOM',1,'Good',1,2015,1,83.65,78.00,1,'SRTMUN',1,24,1,1,1,NULL,4);

select * from candidate_qualification
---------------------------------------------------candidate_docs-------------------------------
insert into candidate_docs values(1,'Adhar','C:\desktop\docs\a.pdf',1,NULL,1);
insert into candidate_docs values(2,'PAN','C:\desktop\docs\b.pdf',1,NULL,1);
insert into candidate_docs values(3,'Adhar','C:\desktop\docs\c.pdf',1,NULL,2);
insert into candidate_docs values(4,'PAN','C:\desktop\docs\d.pdf',1,NULL,3);
insert into candidate_docs values(5,'Adhar','C:\desktop\docs\e.pdf',1,NULL,4);
insert into candidate_docs values(2,'VoterID','C:\desktop\docs\a.pdf',1,NULL,1);
insert into candidate_docs values(4,'Adhar','C:\desktop\docs\e.pdf',1,NULL,4);
